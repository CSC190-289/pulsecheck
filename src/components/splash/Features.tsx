  ...
  return (
    <div ref={props.ref}>
      <Box textAlign={"left"}>
        ...
        <Typography fontWeight={550}>Real-Time Questioning:</Typography>
        <Typography marginLeft={1} marginBottom={2}>
        ...
        <Typography fontWeight={550}>Automatic Scoring:</Typography>
        <Typography marginBottom={2}>
          PulseCheck automatically calculates a participant's quiz scores in{" "}
          <br></br>
        ...
        <Typography fontWeight={550}>Host Dashboard:</Typography>
        <Typography marginBottom={2}>
        ...
        <Typography fontWeight={550}>Web Access & UI:</Typography>
        <Typography marginBottom={2}>
          PulseCheck is a web application that works on Desktop, Tablets, and
          Mobile Devices that support modern web browsers. Built using Firebase,
          React, and Material UI in order to ensure both a fast and optimal user
          experience.
        </Typography>

        <Typography fontWeight={550}>Attendance Tracking:</Typography>
        <Typography marginBottom={2}>
          User participation can serve as a check for who is in attendance.
          Non-participating users are flagged for review and can be removed from
          a poll at the Hosts discretion.
        </Typography>
        ...
        <Typography marginBottom={2}>
          ...
          <br></br>
          randomized to prevent the sharing of answers between participants
          should the host choose.
        </Typography>
      </Box>
    </div>
  )
